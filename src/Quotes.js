const Quotes = [
    {
        id: 1,
        img: ("../src/assets/images_homepage/homepage__avatar__emily-ching.png"),
        name: "Emily Ching",
    ...
    {
        id: 2,
        img: ("../src/assets/images_homepage/homepage__avatar__sean-keating.png"),
        name: "Sean Keating",
    ...
    {
        id: 3,
        img: ("../src/assets/images_homepage/homepage__avatar__jordan-lucero.png"),
        name: "Jordan Lucero",
    ...
    {
        id: 4,
        img: ("../src/assets/images_homepage/homepage__avatar__carlos-torres.png"),
        name: "Carlos Torres",
    ...
    {
        id: 5,
        img: ("../src/assets/images_homepage/homepage__avatar__jon-fox.png"),
        name: "Jon Fox",
    ...
    {
        id: 6,
        img: ("../src/assets/images_homepage/homepage__avatar__johnny-hill.png"),
        name: "Johnny Hill",
